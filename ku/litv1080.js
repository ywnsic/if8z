function main(item) {
  ...
  const n = {
    ...
    "litv-longturn01": [2, 2], // 龍華卡通台
    "litv-longturn02": [3, 2], // 龍華洋片台    
    "litv-longturn03": [3, 2], // 龍華電影台
    "litv-longturn04": [3, 6], // 博斯魅力台
    "litv-longturn05": [3, 2], // 博斯高球台
    "litv-longturn06": [3, 2], // 博斯高球二台
    "litv-longturn07": [3, 2], // 博斯運動一台
    "litv-longturn08": [3, 2], // 博斯運動二台
    "litv-longturn09": [3, 2], // 博斯網球台
    "litv-longturn10": [3, 2], // 博斯無限台
    "litv-longturn11": [3, 2], // 龍華日韓台
    "litv-longturn12": [3, 2], // 龍華偶像台
    "litv-longturn13": [2, 2], // 博斯無限二台
    "litv-longturn14": [1, 2], // 寰宇新聞台
    "litv-longturn16": [2, 0], // 寰宇新聞台灣台
    "litv-longturn17": [1, 2], // 亞洲旅遊台
    "litv-longturn18": [3, 6], // 龍華戲劇台
    "litv-longturn19": [1, 6], // Smart知識台
    "litv-longturn20": [2, 6], // ELTV生活英語台
    "litv-longturn21": [3, 2], // 龍華經典台
